...
A submission to the [International Obfuscated C Coding Competition](http://www.ioccc.org/years.html#1992)
by 'buzzard' first got me interested in Forth. The implementation was brutally
simple and deficient in ways (because of constraints) but it weighed in at about
700 bytes of C and 6.5 kB of Forth and mostly written in itself. In the appendix
I give a largely un-obfuscated version of the code, although no explanation as
to how it works, that is an exercise for you (or you can look at the manual for
the [original](http://www.ioccc.org/1992/buzzard.2.design)).

It just goes to show that you can fit a powerful system in such a small amount
of room.

### Appendix

Save the C program as *third.c* and the forth program as *third.fs*, the reason
it is called 'third' and not 'forth' (or fourth) is because the language
described while essentially being forth is not exactly the same as it.
